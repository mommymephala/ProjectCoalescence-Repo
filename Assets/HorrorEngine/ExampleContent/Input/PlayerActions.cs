    ...
    ""controlSchemes"": []
        ...
        public struct GameplayActions
        {
            ...
            public void SetCallbacks(IGameplayActions instance)
            {
                ...
                {
                    @PrimaryAxis.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnPrimaryAxis;
                    @PrimaryAxis.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnPrimaryAxis;
                    @PrimaryAxis.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnPrimaryAxis;
                    ...
                    @Turn180.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnTurn180;
                    @Turn180.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnTurn180;
                    @Turn180.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnTurn180;
                    @ChangeAimTarget.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnChangeAimTarget;
                    @ChangeAimTarget.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnChangeAimTarget;
                    @ChangeAimTarget.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnChangeAimTarget;
                }
