...
namespace HorrorEngine
{
    public class PlayerStatePushing : ActorState
    {
        ...
        public override void StateEnter(IActorState fromState)
        {
            ...
            m_Movement.Constrain = PlayerMovement.MovementConstrain.Rotation;
        ...
        public override void StateUpdate()
        {
            ...
            Debug.DrawLine(transform.position, transform.position + m_DirAxis*3, Color.blue);
            Actor.transform.rotation = Quaternion.RotateTowards(Actor.transform.rotation, Quaternion.LookRotation(m_DirAxis), m_RotationAngle * (Time.deltaTime / m_InitialDelay));
